...
export default function LandingPage() {
  return <main className={styles.shell}>
    ...
    <section className={styles.difference}><div><span>WHY IT FEELS DIFFERENT</span><h2>It doesn’t just grade your move.</h2></div><div className={styles.featureGrid}><article><b>Why the score moved</b><p>See the Stockfish line behind each change in plain English.</p></article><article><b>A coach you control</b><p>Choose a small nudge, three ideas or the best move. The opponent never sees it.</p></article><article><b>A rival that learns your level</b><p>Strength changes slowly from recent results, and you can always see why.</p></article><article><b>Your complete game story</b><p>Time, thinking, coach use, turning points and milestones in one review.</p></article></div></section>
