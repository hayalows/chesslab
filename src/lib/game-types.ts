...
export type TimeControl = "open" | "blitz5" | "rapid10" | "steady15" | "custom";
export type SessionMode = "game" | "training" | "cup";
export type CustomTimeSettings = { minutes: number; incrementSeconds: number };
